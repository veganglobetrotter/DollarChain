...
<style>
  ...
  .items th{font-weight:700; font-size:12px; text-align:left; padding:6px 0; color:var(--muted);}
  .items td{padding:6px 0; border-bottom:1px dashed #eef2f6;}
  .right{float:right; text-align:right;}
  .total{font-weight:800; font-size:16px; margin-top:8px;}
  .paybox{background:#f9faf9; border:1px solid #eef6ee; padding:8px; border-radius:6px; margin-top:10px; font-size:13px; display:flex; justify-content:space-between; align-items:center;}
  .qr{width:78px; height:78px; background:#fff; border-radius:6px; display:inline-block; object-fit:contain;}
  .foot{font-size:11px; color:var(--muted); margin-top:10px; text-align:center;}
  ...
  <div class="paper" role="article" aria-label="Invoice receipt">
    <div class="hdr">
      ...
      <div style="flex:1;">
        ...
        <div class="meta"> {{sellerPhone}} • {{sellerEmail}}</div>
      </div>
    ...
    <div class="paybox" role="region" aria-label="Payment details">
      <div>
        ...
        <div style="font-weight:700;">{{paymentLabel}}: {{paymentNumber}}</div>
...
<style>
  ...
  .items td{padding:8px 0; border-bottom:1px solid #f1f5f9;}
  .totalRow{display:flex; justify-content:space-between; margin-top:8px; font-weight:800; font-size:16px;}
  .paymentCard{margin-top:12px; border-radius:8px; padding:10px; background:linear-gradient(180deg,#f8fff8,#f0fbf0); border:1px solid #e6f4e8;}
  ...
  <div class="card" role="article" aria-label="Invoice">
    ...
    <div class="paymentCard" role="region" aria-label="Payment details">
      <div style="display:flex; justify-content:space-between; gap:12px; align-items:center;">
        ...
        <div>
          {{#if qrDataUrl}}<img src="{{qrDataUrl}}" alt="QR to pay" style="width:86px;height:86px;border-radius:6px;"/>{{/if}}
        </div>
      </div>
    </div>
...
<style>
  ...
  .pay{margin-top:8px; padding:8px; background:#fbfff9; border:1px solid #eef8ee; border-radius:6px; font-size:12px;}
  .foot{font-size:11px; color:var(--muted); margin-top:8px; text-align:center;}
</style>
</head>
<body>
  <div class="paper" role="article" aria-label="Receipt">
    ...
    <div class="center" style="font-weight:700;">{{sellerName}}</div>
    ...
    <div class="pay">
      ...
      {{#if qrDataUrl}}<div style="margin-top:8px;text-align:center;"><img src="{{qrDataUrl}}" alt="QR" style="width:80px;height:80px;"/></div>{{/if}}
    </div>
...
<style>
  ...
  .logo{height:48px; width:48px; background:rgba(255,255,255,0.06); border-radius:8px; object-fit:contain;}
  .sidebar .brand{font-weight:800; font-size:16px;}
  ...
  <div class="wrap">
    <div class="card" role="article" aria-label="Invoice">
      <aside class="sidebar" aria-hidden="false">
        ...
        <div style="margin-top:auto; font-size:12px; opacity:.9;">Invoice #{{invoiceNumber}}<br/>{{date}}</div>
      </aside>
...
<style>
  ...
  .totals{margin-top:14px; display:flex; justify-content:flex-end; gap:18px; align-items:end;}
